...
SceneTutorial36* SceneTutorial36::Create()
{
    SceneTutorial36 *pRet = new SceneTutorial36;
    if( pRet->Init() ) {
        return pRet;
    }
...
void SceneTutorial36::OnExit()
{
    glDeleteTextures(1,&blurTexture);
}

void SceneTutorial36::Update(float dt)
{
    Scene::Update(dt);
...
void SceneTutorial36::ProcessNormalKeys(unsigned char key, int x, int y)
{

}

GLuint SceneTutorial36::EmptyTexture()                                           // Create An Empty Texture
{
    ...
    for( int i = 0; i < 128 * 128 * 4 * sizeof(unsigned int); i ++ ) {
        data[i] = 0;
    }
...
void SceneTutorial36::ReduceToUnit(float vector[3])                              // Reduces A Normal Vector (3 Coordinates)
...
void SceneTutorial36::calcNormal(float v[3][3], float out[3])                    // Calculates Normal For A Quad Using 3 Points
{
...
void SceneTutorial36::ProcessHelix()                                             // Draws A Helix
{
...
void SceneTutorial36::ViewOrtho()                                                // Set Up An Ortho View
{
...
void SceneTutorial36::ViewPerspective()                                          // Set Up A Perspective View
{
    glMatrixMode( GL_PROJECTION );                              // Select Projection
    glPopMatrix();                                              // Pop The Matrix
...
void SceneTutorial36::RenderToTexture()                                          // Renders To A Texture
{
...
void SceneTutorial36::DrawBlur(int times, float inc)                             // Draw The Blurred Image
{
...
bool SceneTutorial36::Initialize()                 // Any GL Init Code & User Initialiazation Goes Here
{
