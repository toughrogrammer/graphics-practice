...
ModelMilkshape3D* ModelMilkshape3D::Create(std::string path)
{
    ModelMilkshape3D *pRet = new ModelMilkshape3D();
...
bool ModelMilkshape3D::InitWithFile(string path)
{
